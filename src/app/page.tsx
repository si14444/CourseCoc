...
import PlaceCard from '@/components/course/PlaceCard'
...
type ViewMode = 'map' | 'courses' | 'community' | 'editor'
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* 헤더 */}
      <header className="header sticky top-0 z-50 px-6 py-4">
            ...
            <div className="max-w-6xl mx-auto p-6">
              <div className="flex items-center justify-center min-h-[400px]">
                <div className="text-center">
                  ...
                  <p className="mt-4 text-muted">편집기를 로딩 중...</p>
                </div>
              </div>
            </div>
          }>
          ...
          <div className="h-[calc(100vh-80px)]">
            <ClientOnly fallback={
              <div className="h-full bg-surface rounded-lg flex items-center justify-center">
                <div className="text-center">
                  <LoadingSpinner size="lg" />
                  <p className="mt-4 text-muted">지도를 로딩 중...</p>
                </div>
              </div>
            }>
        ...
        {viewMode === 'courses' && (
          <div className="max-w-6xl mx-auto p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h2 className="text-2xl font-bold text-primary mb-2">내가 만든 코스</h2>
                <p className="text-muted">총 {courses.length}개의 코스</p>
              </div>
